...
var words = unsafeWindow.words ??= {
    ...
    */
    ...
    equipsName: {
        ...
        'of the Heaven-sent' : '天堂(神圣)',
        'of the Demon-fiend' : '恶魔(黑暗)',
        'of the Earth-walker' : '地行者(增益)',
        'of the Curse-weaver' : '咒术师(减益)',
