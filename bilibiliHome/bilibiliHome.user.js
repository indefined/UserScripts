                ...
                childs: [
                    {
                        ...
                        childs: [
                            ...
                            },
                            {
                                ...
                                style: 'cursor:pointer;user-select: none;',
                                innerHTML:
                                    '<i class="icon icon_read"></i><span class="info">换一换</span>',
                                onclick: () => {
                                    for (let i = 0; i < setting.manualFreshCount; i++)
                                        getRecommend();
                                },
                        ...
                        */
                            {
                                ...
                                childs: [
                                    ...
                                    ].join('\r\n')}">(?)</span>`,
                                    {
                                        ...
                                        step: 10,
                                        onchange: ({ target }) =>
                                            this.setHistoryLimit(target.value),
                                        style: 'width:50px',
                                    },
                                ],
                            },
                            ...
                            },
                            {
                                ...
                                childs: [
                                    ...
                                    '<span style="margin-right: 5px;color:#00f" title="每次打开首页时自动加载的新推荐页数，每页10条">(?)</span>',
                                    {
                                        ...
                                        step: 1,
                                        onchange: ({ target }) =>
                                            this.setAutoFreshCount(+target.value),
                                        style: 'width:50px',
                                    },
                                ],
                            },
                            {
                                ...
                                childs: [
                                    ...
                                    '<span style="margin-right: 5px;color:#00f" title="每次点击换一换时加载的新推荐页数，每页10条">(?)</span>',
                                    {
                                        nodeType: 'input',
                                        type: 'number',
                            ...
                            },
                            {
                                ...
                                childs: [
                                    ...
                                    '<span style="margin-right: 5px;color:#00f" title="设置一个换一换的快捷键，如果为空则关闭">(?)</span>',
                                    {
                                        nodeType: 'input',
                                        value: this.hotkey,
                            ...
                            },
                            {
                                ...
                                childs: [
                                    ...
                                    '<span style="margin-right: 5px;color:#00f" title="勾选此项推荐框的高度将减去一行间隔，如果你对浏览器进行缩放导致显示超出可以尝试勾选">(?)</span>',
                                    {
                                        ...
                                        onchange: ({ target }) =>
                                            this.setReduceHeight(target.checked),
                            ...
                            },
                            {
                                ...
                                childs: [
                                    ...
                                    '<span style="margin-right: 5px;color:#00f" title="勾选此项将在不显示排行榜时加宽推荐框，但是推荐内容可能会对不齐">(?)</span>',
                                    {
                                        ...
                                        onchange: ({ target }) =>
                                            this.setNoRankingWidth(target.checked),
                                        style: 'vertical-align: bottom',
                                    },
                                ],
                            },
                            {
                                ...
                                childs: [
                                    ...
                                    '<span style="margin-right: 5px;color:#00f" title="勾选此项将把1654px分辨率以下显示整体强制加宽到每行5个推荐，效果和副作用未知，自行尝试">(?)</span>',
                                    {
                                        ...
                                        onchange: ({ target }) =>
                                            this.setForceWidth(target.checked),
                                        style: 'vertical-align: bottom',
                                    },
                                ],
                            },
